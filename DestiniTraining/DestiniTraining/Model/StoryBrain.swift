...
struct StoryBrain {
  let story = [
    ...
    Story(
      ...
      choice2: "It's him or me! Youxa take the knife and stab him.", choice2Destination: 4
    ),
    Story(
  ...
  func getStory() -> String {
    return story[storyTitle].title
  }
  
  mutating func getChoice1() -> String {
    return story[storyTitle].choice1
    
  }
  
  mutating func getChoice2() -> String {
    return story[storyTitle].choice2
  }
  
  mutating func nextStory(userChoice: String) {
    if userChoice == story[storyTitle].choice1 {
      storyTitle = story[storyTitle].choice1Destination
    } else {
      storyTitle = story[storyTitle].choice2Destination
    }
  }
}
